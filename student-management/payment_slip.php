<?php
// Remove this line that causes redirect loop:
...
// Check if student already has active queue (for display purposes)
$checkQuery = "SELECT * FROM queue WHERE student_id = ? AND status IN ('waiting', 'serving') AND DATE(time_in) = CURDATE()";
    ...
    <nav class="navbar navbar-dark bg-dark bg-opacity-50">
        <div class="container-fluid">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="btn btn-outline-light btn-sm me-2" href="student_dashboard.php">
    ...
    <div class="container">
        <div class="payment-slip-container">
            <div class="payment-slip">
                ...
                <form id="paymentForm" method="POST" action="../api/student-api/payment-slip-b.php">
                    ...
                    <div class="text-center mt-4">
                        ...
                        <a href="student_dashboard.php" class="btn btn-secondary btn-lg ms-2">
