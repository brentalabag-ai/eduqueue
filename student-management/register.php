        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <select name="course" class="form-control" required>
                    ...
                    <option value="BSIS" <?= ($_POST['course'] ?? '') === 'BSIS' ? 'selected' : '' ?>>BSIS - Bachelor of Science in Information Systems</option>
                    <option value="BSCE" <?= ($_POST['course'] ?? '') === 'BSCE' ? 'selected' : '' ?>>BSCE - Bachelor of Science in Computer Engineering</option>
                    <option value="BSBA" <?= ($_POST['course'] ?? '') === 'BSBA' ? 'selected' : '' ?>>BSBA - Bachelor of Science in Business Administration</option>
                    <option value="BSEE" <?= ($_POST['course'] ?? '') === 'BSEE' ? 'selected' : '' ?>>BSEE - Bachelor of Science in Electrical Engineering</option>
                </select>
            </div>
        </div>
